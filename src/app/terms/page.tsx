  ...
  return (
    <article className="container-site max-w-3xl space-y-6 py-10">
      ...
      <section className="space-y-3">
        ...
        <p>
          Ставки в каталоге предварительные. Наличие на выбранные даты и окончательную стоимость
          подтверждает менеджер. Сайт не является офертой.
        </p>
      </section>
      <section className="space-y-3">
        <h2 className="text-xl font-semibold">Залог и состояние</h2>
        <p>
          Размер залога уточняется при подтверждении заявки. Фактический залог, фиксация комплектации и
